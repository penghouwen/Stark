...
from .stark.backbone import build_backbone
from .stark.transformer import build_transformer
from .stark.head import build_box_head
...
class SiamTr(nn.Module):
    ...
    def forward_transformer(self, seq_dict, run_box_head=True, run_cls_head=False):
        ...
        # print(type(output_embed), type(enc_mem))
        out= self.forward_box_head(output_embed, enc_mem)
        return out, output_embed
